...
public class MainActivity extends AppCompatActivity
{
    ...
    private ViewPager m_mainViewPager;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        m_mainViewPager = findViewById(R.id.activity_main_viewPager);
        m_tabLayout = findViewById(R.id.activity_main_tabLayout);
        m_tabLayout.setupWithViewPager(m_mainViewPager);
        m_mainViewPager.setAdapter(adapter);
        m_mainViewPager.setCurrentItem(1);
    }
        ...
        switch (requestCode)
        {
            case MY_PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION:
            {
                ...
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED)
                {
                    ...
                    m_mainViewPager.setCurrentItem(CONDITIONS_FRAGMENT_ID);
                }
                else
                {
