...
public class ConditionsFragment extends Fragment implements LocationListener, TextToSpeech.OnInitListener
{
    ...
    private final String TAG = ConditionsFragment.class.getSimpleName();
    ...
    private ProgressBar m_conditionsProgressBar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        m_conditionsProgressBar = rootView.findViewById(R.id.conditions_progress_bar);
        ...
        m_speakConditionsFAB.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View v)
            {
                if (m_weatherAudio == null || m_weatherAudio.isEmpty())
                {
                    Snackbar.make(coordinatorLayoutView, R.string.current_weather, Snackbar.LENGTH_SHORT).show();
                    return;
                }

                if (!m_textToSpeech.isSpeaking())
                {
                    m_textToSpeech.speak(m_weatherAudio, TextToSpeech.QUEUE_FLUSH, null);
                    Snackbar
    ...
    private void requestLocationPermission()
    {
        ...
        else
        {
            ...
            ActivityCompat.requestPermissions(getActivity(),
                new String[]{permission.ACCESS_FINE_LOCATION}, MY_PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION);
        }
    }
...
//		m_location = "27.77,-82.64"; // --> St. Petersburg, FL
    ...
    private void showDialogForPermission()
    {
        ...
        dialogBuilder.setTitle("Permission Required")
            .setMessage(String.format("Permission: %1 required for app to retrieve current weather conditions.", permission.INTERNET.toString()))
    ...
    Runnable internetThreadForWeatherConditions = new Runnable()
    {
        ...
        public void run()
        {
            ...
            try
            {
                ...
                m_weatherAudio = "In " + city + " " + getStateName(state) +
